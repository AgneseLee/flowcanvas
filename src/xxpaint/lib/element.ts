...
//     super(children);
//     this.options = { attrs: {}, styles: {}, on: {}, ...options };
//     this.styles = null;
...
//   _initStyles() {
//     this.styles = { ...this._getDefaultStyles(), ...this._getParentStyles(this.options.styles), ...this.options.styles || {} };
...
//     const { textAlign, lineHeight, fontSize, color, fontFamily, alignItems, visible = true } = this.parent && this.parent.renderStyles || {};
//     const extendStyles = {};
...
//   // 获取文档流中的子节点
//   _getChildrenInFlow() {
//     return this._getChildren().filter((item) => { return item.isInFlow(); });
//   }
...
//   _initPosition() {
//     const { contentX } = this._getContainerLayout();
//     const { paddingLeft, paddingTop, borderLeftWidth, borderTopWidth, marginLeft, marginTop } = this.renderStyles;
//     // 初始化ctx位置
//     if (!this.isInFlow()) {
//       // 不在文档流中
//       const { contentX, contentY, contentWidth, contentHeight } = this._getContainerLayout(this.relativeTo);
